...
If you discover a security vulnerability within this application, please send an e-mail to [Your Name] via [your-email@example.com]. All security vulnerabilities will be promptly addressed.
